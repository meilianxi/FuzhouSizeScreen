<template>
  <div id="westlake">
    ...
    <div class="west-left">
      ...
      <div class="west-title">
        <p style="margin-top: 10px;">
          <img src="../../../static/images/ThreeLanes/1.png"/>
          <span style="font-size: 18px; color: white;">公厕</span>
        </p>
        <p>
          <img src="../../../static/images/ThreeLanes/2.png"/>
          <span style="font-size: 18px; color: white;">酒店</span>
        </p>
        <p>
          <img src="../../../static/images/ThreeLanes/3.png"/>
    ...
    <div class="west-right">
      <p class="west-p"><span class="west-span"></span>&nbsp;&nbsp;三坊七巷风景区个景点<br/>&nbsp;&nbsp;&nbsp;实时客流量排行:</p>
...
<script>
  ...
  import HotMap from "../../components/Map/HotMapWake.vue";
  ...
  export default {
    ...
    data(){
      return{
        longitude: 119.303117,
        latitude: 26.088469,
        mapScale: 18,
        pass:[
          {type: 0, name: "刘家大院", count: 1130},
          {type: 1, name: "林则徐故居", count: 569},
          {type: 2, name: "小黄楼", count: 260},
          {type: 2, name: "水榭歌台", count: 220},
          {type: 1, name: "严复故居", count: 126},
          {type: 0, name: "谢家祠", count: 98},
          {type: 1, name: "程艳故居", count: 43},
          ],
        wake1: true
      }
    },
